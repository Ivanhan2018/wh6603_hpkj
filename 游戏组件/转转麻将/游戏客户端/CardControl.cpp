...
//扑克大小
#define CARD_WIDTH					47									//扑克宽度
#define CARD_HEIGHT					72									//扑克高度

//绘画偏移,用于堆牌,手上牌的绘画
#define Y_USER_LEFT_EXCUSION		18									//显示距离
#define Y_USER_RIGHT_EXCUSION		18									//显示距离
#define Y_TABLE_LEFT_EXCUSION		20									//显示距离
#define Y_TABLE_BOTTOM_EXCUSION		26									//显示距离
#define Y_TABLE_RIGHT_EXCUSION		20									//显示距离
#define Y_TABLE_TOP_EXCUSION		25									//显示距离
#define Y_HEAP_DOUBLE_V_EXCUSION	18									//显示距离

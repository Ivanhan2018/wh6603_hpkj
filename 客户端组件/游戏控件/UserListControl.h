...
//默认颜色
#define COLOR_SELECT_TX				RGB(233,157,159)							//字体颜色
#define COLOR_SELECT_BK				RGB(95,4,142)					//背景颜色
#define COLOR_NORMAL_TX				RGB(233,157,159)							//字体颜色
#define COLOR_NORMAL_BK				RGB(229,249,255)					//背景颜色

//默认颜色
#define COLOR_MYSELF_TX				RGB(29,56,117)						//字体颜色
#define COLOR_MYSELF_BK				RGB(255,0,0)					//背景颜色
#define COLOR_MASTER_TX				RGB(95,106,17)						//字体颜色
#define COLOR_MASTER_BK				RGB(142,4,32)					//背景颜色

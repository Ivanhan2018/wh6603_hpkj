...
BOOL CClientControlItemSinkDlg::OnInitDialog()
{
	...
	SetDlgItemText(IDC_CHECK_TIAN,TEXT("东"));	
	SetDlgItemText(IDC_CHECK_DI,TEXT("南"));	
	SetDlgItemText(IDC_CHECK_XUAN,TEXT("西"));
	SetDlgItemText(IDC_CHECK_HUANG,TEXT("北"));
...
void CClientControlItemSinkDlg::ResetUserBet()
{
	...
	SetDlgItemText(IDC_ST_AREA1,TEXT("东:-----"));
	SetDlgItemText(IDC_ST_AREA2,TEXT("南:-----"));
	SetDlgItemText(IDC_ST_AREA3,TEXT("西:-----"));
	SetDlgItemText(IDC_ST_AREA4,TEXT("北:-----"));
}
...
void CClientControlItemSinkDlg::SetUserBetScore(BYTE cbArea,LONGLONG lScore)
{
	...
	switch(cbArea)
	{
	case 0: strPrint.Format(TEXT("东:%I64d"),m_lAllUserBet[cbArea]);break;
	case 1: strPrint.Format(TEXT("南:%I64d"),m_lAllUserBet[cbArea]);break;
	case 2: strPrint.Format(TEXT("西:%I64d"),m_lAllUserBet[cbArea]);break;
	case 3: strPrint.Format(TEXT("北:%I64d"),m_lAllUserBet[cbArea]);break;
...
void CClientControlItemSinkDlg::SetUserGameScore(BYTE cbArea,LONGLONG lScore)
{
	...
	switch(cbArea)
	{
	case 0: strPrint.Format(TEXT("东:%I64d"),lScore);break;
	case 1: strPrint.Format(TEXT("南:%I64d"),lScore);break;
	case 2: strPrint.Format(TEXT("西:%I64d"),lScore);break;
	case 3: strPrint.Format(TEXT("北:%I64d"),lScore);break;

	default:false;
	}
	SetDlgItemText(IDC_ST_AREA5+cbArea,strPrint);
}

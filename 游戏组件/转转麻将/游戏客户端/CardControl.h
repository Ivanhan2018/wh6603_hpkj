...
protected:
	...
	CPngImage						m_ImageCardShadow;					//牌阴影图片
...
public:
	...
	//扑克阴影
public:
	CPngImage						m_ImageUserTopShadow;				//图片资源
	CPngImage						m_ImageUserLeftShadow;				//图片资源
	CPngImage						m_ImageUserRightShadow;				//图片资源
	CPngImage						m_ImageHeapSingleVShadow;			//图片资源
	CPngImage						m_ImageHeapSingleHShadow;			//图片资源
	CPngImage						m_ImageHeapDoubleVShadow;			//图片资源
	CPngImage						m_ImageHeapDoubleHShadow;			//图片资源
...
protected:
	...
	CPoint							m_ControlPoint;						//基准位置
	CPoint							m_ControlPointNew;					//基准位置
	enDirection						m_CardDirection;					//扑克方向		
	BYTE							m_cbAction;							//方向扑克	
...
protected:
	...
	CPngImage						m_ImageCardShadow;					//阴影图片

...
void CHuiYuanXjYouXiJlDlg::InitListCtrl()
{
	...
	m_listLog.InsertColumn(2, _T("房间名"), LVCFMT_CENTER, 100);
	m_listLog.InsertColumn(3, _T("记录ID"), LVCFMT_CENTER, 100);
	m_listLog.InsertColumn(4, _T("进入时间"), LVCFMT_CENTER, 180);
	m_listLog.InsertColumn(5, _T("盈亏"), LVCFMT_CENTER, 160);
	m_listLog.InsertColumn(6, _T("备注"), LVCFMT_CENTER,223);
}

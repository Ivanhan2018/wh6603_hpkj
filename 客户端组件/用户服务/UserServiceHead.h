...
public:
	...
	//地址描述
	virtual LPCTSTR GetAddrDescribe()=NULL;
...
public:
	...
	//奖牌数值
	virtual SCORE GetUserMedal()=NULL;
	//经验数值
...
interface IUserManagerSink : public IUnknownEx
{
	...
	//用户更新
	virtual VOID OnUserItemUpdate(IClientUserItem * pIClientUserItem, tagUserSpreadInfo & LastSpreadInfo)=NULL;
};
...
public:
	...
	//增加用户
	virtual IClientUserItem * ActiveUserItem(tagUserInfo & UserInfo)=NULL;
...
public:
	...
	//扩展信息
	virtual bool UpdateUserItemSpreadInfo(IClientUserItem * pIClientUserItem, tagUserSpreadInfo * const pUserSpreadInfo)=NULL;	
...
public:
	...
	virtual bool DeleteUserItem(IClientUserItem * pIClientUserItem)=NULL;
	//增加用户
	virtual IClientUserItem * ActiveUserItem(tagUserInfo & UserInfo, BYTE cbCompanion, LPCTSTR pszUserNote)=NULL;
...
public:
	...
	//等级数目
	virtual WORD GetGameLevelCount()=NULL;

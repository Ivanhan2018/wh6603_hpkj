...
protected:
	...
	CString	GetAddressDetail(CString strIpaddress);
	//系统处理
protected:
	//游戏写分
	...
	//解锁用户<by hxh>
	bool OnRequestDeleteUserLocker(DWORD dwContextID, VOID * pData, WORD wDataSize);
	//游戏记录
	...
	//查询IP描述
	bool OnRequestQueryIpDescribe(DWORD dwContextID, VOID * pData, WORD wDataSize);

...
#define SUB_CS_C_CHECK_USER_ONLINE	300									//验证用户在线
#define SUB_CS_C_CHECK_USER_ONLINE_RET	301									//验证用户在线返回

//////////////////////////////////////////////////////////////////////////////////
struct CMD_CS_C_CheckUserOnline
{
	DWORD							dwUserID;
};
struct CMD_CS_C_CheckUserOnlineRet
{
	DWORD							dwUserID;
};
//注册广场

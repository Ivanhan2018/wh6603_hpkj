...
#define SUB_GR_CONFIG_PROPERTY		103									//道具配置<by hxh>
#define SUB_GR_CONFIG_USER_RIGHT	104									//玩家权限<by hxh>
//////////////////////////////////////////////////////////////////////////////////
...
{
	DWORD							dwUserID;							//用户标识
	tagUserSpreadInfo               UserSpreadInfo;                     //扩展信息 
};
...
#define SUB_GR_TRANSFER_SCORE_REQUEST  4                                //转账操作 
#define SUB_GR_QUERY_USER_INFO_REQUEST	5								//查询用户<by hxh>
...
#define SUB_GR_USER_TRANSFER_USER_INFO	103								//用户资料<by hxh>
//////////////////////////////////////////////////////////////////////////////////
...
#define SUB_GR_LIMIT_USER_CHAT		10									//限制聊天<by hxh>
#define SUB_GR_KICK_ALL_USER		11									//踢出用户<by hxh>
#define SUB_GR_DISMISSGAME		    12									//解散游戏<by hxh>
...
//其他信息
#define DTP_GR_TABLE_PASSWORD		1									//桌子密码<by hxh>

//用户属性
#define DTP_GR_NICK_NAME			1									//用户昵称
#define DTP_GR_USER_NOTE			2									//用户备注
#define DTP_GR_ADDR_DESCRIBE        3                                   //地址描述 
#define DTP_GR_GROUP_NAME			4									//社团名字<by hxh>
#define DTP_GR_UNDER_WRITE			5									//个性签名<by hxh>
#define DTP_GR_CUSTOM_FACE			6									//自定头像<by hxh>
//////////////////////////////////////////////////////////////////////////////////
...
//命令代码
#define REQUEST_FAILURE_CMD_NONE     0                                  //原始命令   
#define REQUEST_FAILURE_CMD_CONCLUDE 1                                  //关闭命令

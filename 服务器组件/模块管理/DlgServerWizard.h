...
class MODULE_MANAGER_CLASS CDoubleEdit : public CEdit
{
	//控制变量
private:
	BYTE                        m_cbDecimalCount;                   //小数位数
...
public:
	//设置位数
	inline VOID  SetDecimalCount(BYTE cbDecimalCount) { m_cbDecimalCount=cbDecimalCount; }
...
class MODULE_MANAGER_CLASS CDlgServerOptionItem1 : public CDlgServerOptionItem
{
	//控制变量
private:
	CDoubleEdit                        m_CellScoreEdit;                      //单元积分

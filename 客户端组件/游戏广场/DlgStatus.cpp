...
BOOL CDlgStatus::OnInitDialog()
{
	...
	//设置按钮
	m_btGiveUp.SetWindowPos(NULL,300,10,0,0,SWP_NOSIZE|SWP_NOZORDER);
	...
	SetWindowPos(NULL,15,5,SizeWindow.cx,SizeWindow.cy,SWP_NOZORDER|SWP_NOMOVE|SWP_NOREDRAW);

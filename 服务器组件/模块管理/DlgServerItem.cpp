...
bool CDlgServerItem::GetModuleInitParameter(tagGameServerInfo * pGameServerInfo, bool bAutoMode)
{
	...
	//EWIN网络密码房间//这里是读取数据的!!重要!!m_ModuleInitParameter对象为接口数据传送对象
	m_ModuleInitParameter.GameServiceOption.wServerKind=pGameServerInfo->wServerKind;
	lstrcpyn(m_ModuleInitParameter.GameServiceOption.szServerPassWork,pGameServerInfo->szServerPassWork,CountArray(m_ModuleInitParameter.GameServiceOption.szServerPassWork));

	//虚拟人数
	m_ModuleInitParameter.GameServiceOption.wVirtualUserCount=pGameServerInfo->wVirtualUserCount;
	...
	m_ModuleInitParameter.GameServiceOption.wMinGameUser=pGameServerInfo->wMinGameUser;
	m_ModuleInitParameter.GameServiceOption.wMaxGameUser=pGameServerInfo->wMaxGameUser;

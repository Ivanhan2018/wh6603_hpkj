...
public:
	...
	//单元积分
	virtual VOID SetCellScore(SCORE lCellScore) { m_lCellScore=lCellScore; }
...
public:
	...
	//结束游戏
	virtual bool ConcludeGame(BYTE cbGameStatus,LPCTSTR szDrawInfo,WORD cbMcYes);

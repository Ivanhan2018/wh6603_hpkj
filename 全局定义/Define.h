...
//列表定义
#define MAX_KIND					32									//最大类型
#define MAX_SERVER					256						    		//最大房间
...
//税收定义
#define REVENUE_BENCHMARK			0.00f								//税收起点
...
//游戏记录
#define DRAW_INFO_MAX_LEN           4000                                //最大长度 
...
#define TRUMPET_MAX_CHAR            128									//喇叭长度<by hxh>
...
#define LEN_ADDR_DESCRIBE          		128                                					 //地址描述
...
//基本属性
#define UD_USER_ID					1									//用户标识
#define	UD_NICKNAME					2									//用户昵称

//扩展属性
#define UD_GENDER					10									//用户性别
#define UD_EXPERIENCE				11									//用户经验
...
#define UD_WIN_COUNT				32									//胜局盘数
#define UD_LOST_COUNT				33									//输局盘数
#define UD_DRAW_COUNT				34									//和局盘数
#define UD_FLEE_COUNT				35									//逃局盘数
#define UD_PLAY_COUNT				36									//总局盘数
...
#define PLAZA_TYPE_NORMAL           0                                   //普通广场
#define PLAZE_TYPE_MULTI            1                                   //多开广场 

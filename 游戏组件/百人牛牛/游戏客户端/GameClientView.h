...
public:	
	...
	BYTE							m_cbUserCardType[AREA_COUNT+1];		//牌型
...
public:
	...
	CSkinButton						m_btLast;							//上一首
	CSkinButton						m_btNext;							//下一首
public:
...
protected:
	...
	CBitmap							m_ImageViewBack;					//背景位图
	CBitmap							m_ImageWinFlags;					//标志位图
	...
	CBitmap							m_ImageMeScoreNumber;					//数字视图
	CBitmap							m_ImageTimeFlag;					//时间标识
	CBitmap							m_ImageDispatchCardTip;				//发牌提示
	CBitmap							m_ImageCardType[AREA_COUNT+1];		//数字视图

	//边框资源
protected:
	CBitmap						m_ImageFrameTianMen;				//边框图片
	CBitmap						m_ImageFrameDiMen;					//边框图片
	CBitmap						m_ImageFrameHuangMen;				//边框图片
	CBitmap						m_ImageFrameXuanMen;				//边框图片

	CBitImageEx						m_ImageMeBanker;					//切换庄家
	CBitImageEx						m_ImageChangeBanker;				//切换庄家
	CBitImageEx						m_ImageNoBanker;					//切换庄家

	CSiceControl					m_Sice[2];							///骰子
	CZhuangControl					m_Zhuang;							///庄家


	//结束资源
protected:
	CBitmap						m_ImageGameEnd;						//成绩图片

...
CString   CPaiLie3::m_strHaoma = _T("");
//排列3

IMPLEMENT_DYNAMIC(CPaiLie3, CDialog)

CPaiLie3::CPaiLie3(CWnd* pParent /*=NULL*/)
	: CDialog(CPaiLie3::IDD, pParent)
	, m_bmpBk(NULL)
	, m_numImageList(NULL)
	, m_kjNumBig(NULL)
	, m_kjNumSmall(NULL)
...
void CPaiLie3::ConnectMainDlg(CPlazaViewItem* luckMeDlg)
{
	m_pLuckMeDlg = luckMeDlg;
}

void CPaiLie3::FlushZongjine()
{
	InvalidateRect(&rcZongJinE);
}

void CPaiLie3::DoDataExchange(CDataExchange* pDX)
{
...
BEGIN_MESSAGE_MAP(CPaiLie3, CDialog)
	ON_BN_CLICKED(IDC_BTN_MORE_RECORD, &CPaiLie3::OnBnClickedBtnMoreRecord)
	ON_BN_CLICKED(IDC_BTN_YUAN, &CPaiLie3::OnBnClickedBtnYuan)
	ON_BN_CLICKED(IDC_BTN_JIAO, &CPaiLie3::OnBnClickedBtnJiao)
	ON_BN_CLICKED( IDC_BTN_FEN, &CPaiLie3::OnBnClickedBtnFen)
	ON_BN_CLICKED(IDC_BTN_LI, &CPaiLie3::OnBnClickedBtnLi)
	ON_BN_CLICKED(IDC_BTN_3D_SXZHX, &CPaiLie3::OnBnClickedBtn3dSxzhx)
	ON_BN_CLICKED(IDC_BTN_3D_SXZX, &CPaiLie3::OnBnClickedBtn3dSxzx)
	ON_BN_CLICKED(IDC_BTN_3D_QYZHX, &CPaiLie3::OnBnClickedBtn3dQyzhx)
	ON_BN_CLICKED(IDC_BTN_3D_QEZHX, &CPaiLie3::OnBnClickedBtn3dQezhx)
	ON_BN_CLICKED(IDC_BTN_3D_SXBDW, &CPaiLie3::OnBnClickedBtn3dSxbdw)
	ON_BN_CLICKED(IDC_BTN_3D_HYZHX, &CPaiLie3::OnBnClickedBtn3dHyzhx)
	ON_BN_CLICKED(IDC_BTN_3D_HEZHX, &CPaiLie3::OnBnClickedBtn3dHezhx)
	ON_BN_CLICKED(IDC_BTN_3D_DWD, &CPaiLie3::OnBnClickedBtn3dDwd)
	ON_BN_CLICKED(IDC_BTN_3D_DWDXDS, &CPaiLie3::OnBnClickedBtn3dDxds)
	ON_BN_CLICKED(IDC_BTN_BAI_3D_QUAN, &CPaiLie3::OnBnClickedBtnBai3dQuan)
	ON_BN_CLICKED(IDC_BTN_BAI_3D_DA, &CPaiLie3::OnBnClickedBtnBai3dDa)
	ON_BN_CLICKED(IDC_BTN_BAI_3D_XIAO, &CPaiLie3::OnBnClickedBtnBai3dXiao)
	ON_BN_CLICKED(IDC_BTN_BAI_3D_DAN, &CPaiLie3::OnBnClickedBtnBai3dDan)
	ON_BN_CLICKED(IDC_BTN_BAI_3D_SHUANG, &CPaiLie3::OnBnClickedBtnBai3dShuang)
	ON_BN_CLICKED(IDC_BTN_BAI_3D_QING, &CPaiLie3::OnBnClickedBtnBai3dQing)
	ON_BN_CLICKED(IDC_BTN_SHI_3D_QUAN, &CPaiLie3::OnBnClickedBtnShi3dQuan)
	ON_BN_CLICKED(IDC_BTN_SHI_3D_DA, &CPaiLie3::OnBnClickedBtnShi3dDa)
	ON_BN_CLICKED(IDC_BTN_SHI_3D_XIAO, &CPaiLie3::OnBnClickedBtnShi3dXiao)
	ON_BN_CLICKED(IDC_BTN_SHI_3D_DAN, &CPaiLie3::OnBnClickedBtnShi3dDan)
	ON_BN_CLICKED(IDC_BTN_SHI_3D_SHUANG, &CPaiLie3::OnBnClickedBtnShi3dShuang)
	ON_BN_CLICKED(IDC_BTN_SHI_3D_QING, &CPaiLie3::OnBnClickedBtnShi3dQing)
	ON_BN_CLICKED(IDC_BTN_GE_3D_QUAN, &CPaiLie3::OnBnClickedBtnGe3dQuan)
	ON_BN_CLICKED(IDC_BTN_GE_3D_DA, &CPaiLie3::OnBnClickedBtnGe3dDa)
	ON_BN_CLICKED(IDC_BTN_GE_3D_XIAO, &CPaiLie3::OnBnClickedBtnGe3dXiao)
	ON_BN_CLICKED(IDC_BTN_GE_3D_DAN, &CPaiLie3::OnBnClickedBtnGe3dDan)
	ON_BN_CLICKED(IDC_BTN_GE_3D_SHUANG, &CPaiLie3::OnBnClickedBtnGe3dShuang)
	ON_BN_CLICKED(IDC_BTN_GE_3D_QING, &CPaiLie3::OnBnClickedBtnGe3dQing)
	ON_WM_PAINT()
	ON_WM_ERASEBKGND()
	ON_WM_SIZE()
	ON_BN_CLICKED(IDC_RIO_SXZHX_FUSHI, &CPaiLie3::OnBnClickedRioSxzhxFushi)
	ON_BN_CLICKED(IDC_RIO_SXZHX_DANSHI, &CPaiLie3::OnBnClickedRioSxzhxDanshi)
	ON_BN_CLICKED(IDC_RIO_HEZHX_FUSHI, &CPaiLie3::OnBnClickedRioHezhxFushi)
	ON_BN_CLICKED(IDC_RIO_HEZHX_DANSHI, &CPaiLie3::OnBnClickedRioHezhxDanshi)
	ON_BN_CLICKED(IDC_RIO_SXZS_FUSHI, &CPaiLie3::OnBnClickedRioSxzsFushi)
	ON_BN_CLICKED(IDC_RIO_SXZS_DANSHI, &CPaiLie3::OnBnClickedRioSxzsDanshi)
	ON_BN_CLICKED(IDC_RIO_SXZL_FUSHI, &CPaiLie3::OnBnClickedRioSxzlFushi)
	ON_BN_CLICKED(IDC_RIO_SXZL_DANSHI, &CPaiLie3::OnBnClickedRioSxzlDanshi)
	ON_BN_CLICKED(IDC_RIO_QYZHX, &CPaiLie3::OnBnClickedRioQyzhx)
	ON_BN_CLICKED(IDC_RIO_QEZHX_FUSHI, &CPaiLie3::OnBnClickedRioQezhxFushi)
	ON_BN_CLICKED(IDC_RIO_QEZHX_DANSHI, &CPaiLie3::OnBnClickedRioQezhxDanshi)
	ON_BN_CLICKED(IDC_RIO_SXBDW, &CPaiLie3::OnBnClickedRioSxbdw)
	ON_BN_CLICKED(IDC_RIO_HYZHX, &CPaiLie3::OnBnClickedRioHyzhx)
	ON_BN_CLICKED(IDC_RIO_SXZHX_HEZHI, &CPaiLie3::OnBnClickedRioSxzhxHezhi)
	ON_BN_CLICKED(IDC_BTN_3D_ADD, &CPaiLie3::OnBnClickedBtn3dAdd)
	ON_BN_CLICKED(IDC_RIO_DWD, &CPaiLie3::OnBnClickedRioDwd)
	ON_BN_CLICKED(IDC_RIO_DWDXDS, &CPaiLie3::OnBnClickedRioDwDxds)

	ON_WM_TIMER()
	ON_WM_SHOWWINDOW()
	ON_BN_CLICKED(IDC_BTN_DEL_SEL, &CPaiLie3::OnBnClickedBtnDelSel)
	ON_BN_CLICKED(IDC_BTN_CLS_LIST, &CPaiLie3::OnBnClickedBtnClsList)
	ON_BN_CLICKED(IDC_BTN_TOUZHU, &CPaiLie3::OnBnClickedBtnTouzhu)
	ON_BN_CLICKED(IDC_BTN_ZHUIHAO, &CPaiLie3::OnBnClickedBtnZhuihao)
	ON_EN_CHANGE(IDC_EDIT_BEISHU, &CPaiLie3::OnEnChangeEditBeishu)
	ON_EN_CHANGE(IDC_EDIT_DANSHI_HAOMA, &CPaiLie3::OnEnChangeEditDanshiInput)
	ON_BN_CLICKED(IDC_BTN_LOCK, &CPaiLie3::OnBnClickedBtnLock)
	ON_BN_CLICKED(IDC_BTN_BEITOU_JIA, &CPaiLie3::OnBnClickedBeiTouJia)
	ON_BN_CLICKED(IDC_BTN_BEITOU_JIAN, &CPaiLie3::OnBnClickedBeiTouJian)
	ON_MESSAGE( WM_BN_CLICK, &CPaiLie3::onBnCLick)
	ON_EN_CHANGE(IDC_RICHEDIT_DANSHI, &CPaiLie3::OnEnChangeRichEditDanshiInput)
	ON_COMMAND(ID_RBTN_CPY, &CPaiLie3::OnRichEditCopy)
...
BOOL CPaiLie3::OnEraseBkgnd(CDC* pDC)
{
	return TRUE;
}

void CPaiLie3::OnSize(UINT nType, int cx, int cy)
{
...
void CPaiLie3::OnBnClickedBtnYuan()
{
...
void CPaiLie3::OnBnClickedBtnJiao()
{
...
void CPaiLie3::OnBnClickedBtnFen()
{
	m_btnYuan.SetPushed(false);
	m_btnJiao.SetPushed(false);
...
void CPaiLie3::OnBnClickedBtnLi()
{
	m_btnYuan.SetPushed(false);
	m_btnJiao.SetPushed(false);
	m_btnFen.SetPushed(false);
...
void CPaiLie3::OnTimer(UINT_PTR nIDEvent)
{
...
void CPaiLie3::OnShowWindow(BOOL bShow, UINT nStatus)
{
...
HBRUSH CPaiLie3::OnCtlColor(CDC* pDC, CWnd* pWnd, UINT nCtlColor)
{
...
//三星直选
void CPaiLie3::OnBnClickedBtn3dSxzhx()
{
	//m_wanfa = SanXingZhiXuan;
...
//三星组选
void CPaiLie3::OnBnClickedBtn3dSxzx()
{
	//m_wanfa = SanXingZuXuan;
	...
	//SelctRadioBtn(IDC_RIO_SXZS_FUSHI);
	OnBnClickedRioSxzsFushi();
}

//前一直选
void CPaiLie3::OnBnClickedBtn3dQyzhx()
{
	...
	//SelctRadioBtn(IDC_RIO_QYZHX);
	OnBnClickedRioQyzhx();
}

//前二直选
void CPaiLie3::OnBnClickedBtn3dQezhx()
{
	//m_wanfa = QianErZhiXuan;
...
//三星不定位
void CPaiLie3::OnBnClickedBtn3dSxbdw()
{
	...
	//SelctRadioBtn(IDC_RIO_SXBDW);
	OnBnClickedRioSxbdw();
}

//后一直选
void CPaiLie3::OnBnClickedBtn3dHyzhx()
{
	...
	//SelctRadioBtn(IDC_RIO_HYZHX);
	OnBnClickedRioHyzhx();
}

//后二直选
void CPaiLie3::OnBnClickedBtn3dHezhx()
{
	//m_wanfa = HouErZhiXuan;
...
//定位胆
void CPaiLie3::OnBnClickedBtn3dDwd()
{
...
//大小单双
void CPaiLie3::OnBnClickedBtn3dDxds()
{
...
void CPaiLie3::OnBnClickedBtnBai3dQuan()
{
...
void CPaiLie3::OnBnClickedBtnBai3dDa()
{
...
void CPaiLie3::OnBnClickedBtnBai3dXiao()
{
	CheckNumBtn(m_btn3DBai0);
	CheckNumBtn(m_btn3DBai1);
	CheckNumBtn(m_btn3DBai2);
...
void CPaiLie3::OnBnClickedBtnBai3dDan()
{
	UnCheckNumBtn(m_btn3DBai0);
	CheckNumBtn(m_btn3DBai1);
	UnCheckNumBtn(m_btn3DBai2);
...
void CPaiLie3::OnBnClickedBtnBai3dShuang()
{
	CheckNumBtn(m_btn3DBai0);
	UnCheckNumBtn(m_btn3DBai1);
	CheckNumBtn(m_btn3DBai2);
...
void CPaiLie3::OnBnClickedBtnBai3dQing()
{
	UnCheckNumBtn(m_btn3DBai0);
	UnCheckNumBtn(m_btn3DBai1);
	UnCheckNumBtn(m_btn3DBai2);
...
void CPaiLie3::OnBnClickedBtnShi3dQuan()
{
...
void CPaiLie3::OnBnClickedBtnShi3dDa()
{
...
void CPaiLie3::OnBnClickedBtnShi3dXiao()
{
	CheckNumBtn(m_btn3DShi0);
	CheckNumBtn(m_btn3DShi1);
	CheckNumBtn(m_btn3DShi2);
...
void CPaiLie3::OnBnClickedBtnShi3dDan()
{
	UnCheckNumBtn(m_btn3DShi0);
	CheckNumBtn(m_btn3DShi1);
	UnCheckNumBtn(m_btn3DShi2);
...
void CPaiLie3::OnBnClickedBtnShi3dShuang()
{
	CheckNumBtn(m_btn3DShi0);
	UnCheckNumBtn(m_btn3DShi1);
	CheckNumBtn(m_btn3DShi2);
...
void CPaiLie3::OnBnClickedBtnShi3dQing()
{
	UnCheckNumBtn(m_btn3DShi0);
	UnCheckNumBtn(m_btn3DShi1);
	UnCheckNumBtn(m_btn3DShi2);
...
void CPaiLie3::OnBnClickedBtnGe3dQuan()
{
...
void CPaiLie3::OnBnClickedBtnGe3dDa()
{
...
void CPaiLie3::OnBnClickedBtnGe3dXiao()
{
	CheckNumBtn(m_btn3DGe0);
	CheckNumBtn(m_btn3DGe1);
	CheckNumBtn(m_btn3DGe2);
...
void CPaiLie3::OnBnClickedBtnGe3dDan()
{
	UnCheckNumBtn(m_btn3DGe0);
	CheckNumBtn(m_btn3DGe1);
	UnCheckNumBtn(m_btn3DGe2);
...
void CPaiLie3::OnBnClickedBtnGe3dShuang()
{
	CheckNumBtn(m_btn3DGe0);
	UnCheckNumBtn(m_btn3DGe1);
	CheckNumBtn(m_btn3DGe2);
...
void CPaiLie3::OnBnClickedBtnGe3dQing()
{
	UnCheckNumBtn(m_btn3DGe0);
	UnCheckNumBtn(m_btn3DGe1);
	UnCheckNumBtn(m_btn3DGe2);
...
void CPaiLie3::OnBnClickedRioSxzhxFushi()
{
	ResetAllNums();
...
void CPaiLie3::OnBnClickedRioSxzhxDanshi()
{
	ResetAllNums();
...
void CPaiLie3::OnBnClickedRioHezhxFushi()
{
	ResetAllNums();
...
void CPaiLie3::OnBnClickedRioHezhxDanshi()
{
	ResetAllNums();
...
void CPaiLie3::OnBnClickedRioSxzsFushi()
{
	ResetAllNums();
...
void CPaiLie3::OnBnClickedRioSxzsDanshi()
{
	ResetAllNums();
...
void CPaiLie3::OnBnClickedRioSxzlFushi()
{
	ResetAllNums();
...
void CPaiLie3::OnBnClickedRioSxzlDanshi()
{
	ResetAllNums();
...
void CPaiLie3::OnBnClickedRioQyzhx()
{
	ResetAllNums();
...
void CPaiLie3::OnBnClickedRioQezhxFushi()
{
	ResetAllNums();
...
void CPaiLie3::OnBnClickedRioQezhxDanshi()
{
	ResetAllNums();
...
void CPaiLie3::OnBnClickedRioSxbdw()
{
	ResetAllNums();
...
void CPaiLie3::OnBnClickedRioHyzhx()
{
	ResetAllNums();
...
void CPaiLie3::OnBnClickedRioDwd()
{
	ResetAllNums();
...
//定位大小单双
void CPaiLie3::OnBnClickedRioDwDxds()
{
	ResetAllNums();
...
void CPaiLie3::OnBnClickedRioSxzhxHezhi()
{
	// 	ResetAllNums();
	// 
...
//服务器端返回前N个开奖号码
bool CPaiLie3::GetTopLuckyNumber(CMD_GP_QueryLotResult* pResult, int	nIndex)
{
...
CString CPaiLie3::GetScoreMoshi()
{
	if(theAccount.Scoretype == MoShi_Yuan)
	{
		return _T("元");
...
int CPaiLie3::GetMoshiRet(CString moshi)
{
	if(moshi == _T("元"))
	{
		return MoShi_Yuan;
...
void CPaiLie3::OnBnClickedBtn3dAdd()
{
...
void CPaiLie3::OnBnClickedBtnDelSel()
{
...
void CPaiLie3::OnBnClickedBtnClsList()
{
...
void CPaiLie3::OnBnClickedBtnTouzhu()
{
...
void CPaiLie3::OnBnClickedBtnZhuihao()
{
	int itm_cnt = m_list3D.GetItemCount();
	if (itm_cnt<=0)
	{
	...
	if(m_bKaiJiangzhong)
		dlgZhuiHao.SetCurrentQihaoTime(GetNextExpect(), strBeishu,4,3, m_zongJine,357,CZPaiLie3);
	else
		dlgZhuiHao.SetCurrentQihaoTime( m_kjXinxi[0].qihao, strBeishu,4,3, m_zongJine,357,CZPaiLie3);
...
void CPaiLie3::OnEnChangeEditDanshiInput()
{
...
void CPaiLie3::OnEnChangeEditBeishu()
{
	...
	{
		UpdateData();
		Get3dZhushu(CZPaiLie3,m_gameKind);
		CRect rcInvali;
		rcInvali.CopyRect(rcZongZhuShu);
		rcInvali.right+=400;
		InvalidateRect(&rcInvali);
...
void CPaiLie3::CheckNumBtn(CNumerButton& btn)
{
	btn.SetSelect(true);
}

void CPaiLie3::UnCheckNumBtn(CNumerButton& btn)
{
	btn.SetSelect(false);
}

bool CPaiLie3::IsNumBtnCheck(CNumerButton& btn)
{
	return btn.IsSelect();
}

void CPaiLie3::HideCtrl(int ctrl_id)
{
...
void CPaiLie3::ShowCtrl(int ctrl_id)
{
	CWnd* pWnd = GetDlgItem(ctrl_id);
	if (pWnd != NULL) 
	{
...
BOOL CPaiLie3::PreTranslateMessage(MSG* pMsg)
{
...
//void CPaiLie3::SelctRadioBtn(int ctrl_id)
//{
...
void CPaiLie3::CheckWanFaBtn(CTextButton& btn)
{
...
void CPaiLie3::ShowDanShiEdit()
{
	m_richDanshiHaoma.ShowWindow(SW_SHOW);
}

void CPaiLie3::ResetAllNums()
{
	m_singlezhushu = 0;
...
tagEnumTreeNumbers CPaiLie3::GetWanFaByDesc(const CString& desc)
{
	if (desc == _T("三星直选复式")) 
	{
...
void CPaiLie3::DrawLastKjHaoma(CDC* pDC, Graphics& graphics)
{
	int nTimeLeft = GetKjShjDiff();
	...
	pDC->DrawText(_T("排列三"), &rcCzh, DT_CENTER|DT_VCENTER|DT_SINGLELINE);
	CRect rcDi;
...
void CPaiLie3::DrawTopKjHaoma(CDC* pDC, Graphics& graphics)
{
	CString strText;
	int oldBkMode = pDC->SetBkMode(TRANSPARENT);
...
void CPaiLie3::DrawBigNum(Graphics& graphics, Bitmap* img, Rect& rc_dest, int num)
{
	graphics.DrawImage(img, rc_dest, num*m_bigNumWidth, 0, m_bigNumWidth, m_bigNumHeight, UnitPixel);
}

void CPaiLie3::DrawSmallNum(Graphics& graphics, Bitmap* img, Rect& rc_dest, int num)
{
	graphics.DrawImage(img, rc_dest, num*m_smallNumWidth, 0, m_smallNumWidth, m_smallNumHeight, UnitPixel);
}

void CPaiLie3::DrawZongZhushuJinE(CDC* pDC)
{
	CString strText;
	int oldBkMode = pDC->SetBkMode(TRANSPARENT);
...
CString CPaiLie3::GetNextExpect()
{
	if (_tcslen(m_lastExpect) == 0)
	{
		return _T("---");
...
CString CPaiLie3::GetKjShjDiffDesc()
{
	if (_tcslen(m_lastExpect) == 0)
	{
		return _T("00:00");	
...
//	OnBnClickedBtnClsList();
// 	CString str;
// 	int index = (CZPaiLie3 << 16) | (unsigned short)m_gameKind;
// 	str.Format(_T("%.2lf/%.2lf"), theBonus[index], theAccount.fandian*100.0);
// 
// 	m_btnLock.SetWindowText(str + _T("%"));
}

bool CPaiLie3::GetZuSanHaoma(CStringArray& strArr)
{
	CString line;
...
bool CPaiLie3::GetZuSanHaoma(CString& haoma, int& zhushu)
{
	CStringArray strArr;
...
bool CPaiLie3::IsZuSanHaoma(const CString& str)
{
	if(str.GetLength() != 3)
	{
		return false;
...
bool CPaiLie3::GetDanShiHaoma(CString& haoma, int size, int& zhushu)
{
	CStringArray strArr;
	CString line;
...
bool CPaiLie3::GetHaomaStrs(CStringArray& strArr, CString line, int size)
{
...
//初始化玩法信息
void CPaiLie3::InitWanFaMoShi()
{
	theGameKind[(CZPaiLie3 << 16) | (unsigned short)enWF_ZhixuanFushi] = _T("三星直选复式");		
	theGameKind[(CZPaiLie3 << 16) | (unsigned short)enWF_ZhixuanDanshi] = _T("三星直选单式");
	theGameKind[(CZPaiLie3 << 16) | (unsigned short)enWF_DingWeiDan] = _T("定位胆");
	theGameKind[(CZPaiLie3 << 16) | (unsigned short)enWF_DaxiaoDanshuang] = _T("大小单双");

	theGameKind[(CZPaiLie3 << 16) | (unsigned short)enWF_QiansanzusanFushi] = _T("三星组选组三复式");
	theGameKind[(CZPaiLie3 << 16) | (unsigned short)enWF_QiansanzusanDanshi] = _T("三星组选组三单式");
	theGameKind[(CZPaiLie3 << 16) | (unsigned short)enWF_QiansanzuliuFushi] =  _T("三星组选组六复式");
	theGameKind[(CZPaiLie3 << 16) | (unsigned short)enWF_QiansanzuliuDanshi] = _T("三星组选组六单式");

	theGameKind[(CZPaiLie3 << 16) | (unsigned short)enWF_QianyizhixuanFushi] = _T("前一直选");

	theGameKind[(CZPaiLie3 << 16) | (unsigned short)enWF_QianerzhixuanFushi] = _T("前二直选复式");
	theGameKind[(CZPaiLie3 << 16) | (unsigned short)enWF_QianerzhixuanDanshi] = _T("前二直选单式");

	theGameKind[(CZPaiLie3 << 16) | (unsigned short)enWF_Budingwei] = _T("三星不定位");

	theGameKind[(CZPaiLie3 << 16) | (unsigned short)enWF_HouyizhixuanFushi] = _T("后一直选");

	theGameKind[(CZPaiLie3 << 16) | (unsigned short)enWF_HouerzhixuanFushi] = _T("后二直选复式");
	theGameKind[(CZPaiLie3 << 16) | (unsigned short)enWF_HouerzhixuanDanshi] = _T("后二直选单式");
}

//读取事件
bool CPaiLie3::OnEventMissionRead(TCP_Command Command, VOID * pData, WORD wDataSize)
{
	//命令处理
...
VOID CPaiLie3::SendToServer(int nSendType)
{
	...
	if(nSendType == 1)
	{
		...
		for(int i = 0;i < itm_cnt;i++)
		{
			...
			TouzhuCQSSC.nGameType = CZPaiLie3;
...
/*
		CString gamekind = m_list3D.GetItemText(0, 1);
		for(int n=0; n<m_nZhuihaoCount; n++)
		{
			...
			for (int i=0; i<itm_cnt; i++) 
			{
				CString haomao = vecAllNums[i].c_str();
				CString zhushu = m_list3D.GetItemText(i, 4);
				if(haomao.IsEmpty())
				{
					m_DlgStatus.HideStatusWindow();
					MyMessageBox(L"你还未选择号码，请选择！");
			...
			string sNowQi;
			ChangeStringToA(GetNextExpect(),sNowQi);
			USES_CONVERSION;
...
*/
	...
	if(nSendType == 5)
	{
		...
		SetUserBonus.n_t_type_id = CZPaiLie3;
	...
	if(nSendType == 6)
	{
		...
		GetUserFandian.n_t_type_id = CZPaiLie3;
	...
	if(nSendType == 8)
	{
		...
		GetMoreRecord.n_t_type = CZPaiLie3;
...
void CPaiLie3::OnBnClickedBtnMoreRecord()
{
	SendToServer(8);
	return;
}

bool	CPaiLie3::ChangeStringToA(CString strInput, string&  strOutput)
{
...
//设置返点
void CPaiLie3::OnBnClickedBtnLock()
{
	int index = (CZPaiLie3 << 16) | (unsigned short)m_gameKind;
...
//倍投加
void CPaiLie3::OnBnClickedBeiTouJia()
{
	CString strBeishu;
...
//倍投减
void CPaiLie3::OnBnClickedBeiTouJian()
{
	CString strBeishu;
...
CString CPaiLie3::GetBaiDxdshString()
{
	CString strBai;
...
CString CPaiLie3::GetShiDxdshString()
{
	CString strShi;
...
CString CPaiLie3::GetGeDxdshString()
{
	CString strGe;
...
CString CPaiLie3::GetDxdshStringDesc(int nNum)
{
	CString strDesc;
	switch (nNum)
	{
...
void CPaiLie3::ShowDaXiaoDanShuang()
{
	m_staticBai.ShowWindow(SW_SHOW);
	m_staticShi.ShowWindow(SW_SHOW);
	m_staticGe.ShowWindow(SW_SHOW);
...
void CPaiLie3::HideDaXiaoDanShuang()
{
	m_staticBai.ShowWindow(SW_HIDE);
	m_staticShi.ShowWindow(SW_HIDE);
	m_staticGe.ShowWindow(SW_HIDE);
...
LRESULT CPaiLie3::onBnCLick( WPARAM wParam, LPARAM lParam )
{
...
BOOL CPaiLie3::OnCommand(WPARAM wParam, LPARAM lParam)
{
	//变量定义
...
int CPaiLie3::Get3dZhushu(int nTypeID,int nKindID)
{
	CString strBai = GetBaiString();
	CString strShi = GetShiString();
	CString strGe = GetGeString();
...
void CPaiLie3::OnEnChangeRichEditDanshiInput()
{
...
int CPaiLie3::GetDanShiZhusu(int nKind)
{

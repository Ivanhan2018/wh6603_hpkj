...
IAndroidUserItem * CAndroidUserManager::CreateAndroidUserItem(tagAndroidParameter & AndroidParameter)
{
	...
	LogonUserID.dwProcessVersion=(VERSION_EFFICACY==TRUE)?m_pGameServiceAttrib->dwClientVersion:m_pGameParameter->dwClientVersion;
...
//						m_nAndroidCount+=1;
// 						CString strLog;
// 						strLog.Format(L"ANDROIDUSER m_nAndroidCount:%d人",m_nAndroidCount);
...
// 						{
// 							CString strLog;
// 							strLog.Format(L"[%s]进入游戏",pAndroidUserItem->GetMeUserItem()->GetNickName());

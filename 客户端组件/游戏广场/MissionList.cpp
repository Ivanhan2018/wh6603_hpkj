...
//连接事件
bool CMissionList::OnEventMissionLink(INT nErrorCode,INT nSocketID)
{
	//错误判断
	if (nErrorCode!=0L)
	{
...
// 	pPlatforFrame->m_MissionManager.SendData(MDM_GP_SERVER_LIST,SUB_GP_GET_ONLINE,&GetOnline,wSendSize);

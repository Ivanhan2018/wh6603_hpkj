...
void CZhangHuTzhLogDlg::InitListCtrl()
{
	...
	m_listLog.InsertColumn(2, _T("投注模式"), LVCFMT_CENTER, 143);
	m_listLog.InsertColumn(3, _T("投注期号"), LVCFMT_CENTER, 130);
	m_listLog.InsertColumn(4, _T("投注金额"), LVCFMT_CENTER, 110);

...
VOID CLogonServerDlg::OnServiceUnitsStatus(enServiceStatus ServiceStatus)
{
	...
	case ServiceStatus_Service:	//服务状态
		{
			CString strLog;
			strLog.Format(L"登录服务器版本:%ld.%ld.%ld  -- [ 运行 ]", m_ServiceUnits.m_AttemperEngineSink.m_pInitParameter->m_dwMainVer, m_ServiceUnits.m_AttemperEngineSink.m_pInitParameter->m_dwSubVer,m_ServiceUnits.m_AttemperEngineSink.m_pInitParameter->m_dwProductVer);
			...
			strLog.Format(L"登录服务器版本:%ld.%ld.%ld  -- [ 启动成功 ]", m_ServiceUnits.m_AttemperEngineSink.m_pInitParameter->m_dwMainVer, m_ServiceUnits.m_AttemperEngineSink.m_pInitParameter->m_dwSubVer,m_ServiceUnits.m_AttemperEngineSink.m_pInitParameter->m_dwProductVer);

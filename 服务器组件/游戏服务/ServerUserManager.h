...
protected:
	...
	tagUserRule						m_UserRule;							//用户规则<by hxh>
	tagUserScore					m_ScoreFormer;						//先前分数
	//tagUserProperty                 m_UserProperty;                     //玩家道具<by hxh>
...
public:
	...
	//广场类型
	virtual BYTE  GetPlazeType() { return m_cbPlazaType; }
...
public:
	//地址变更
	virtual bool SetIpAddrDescribe(LPCTSTR pszAddrDescibe);
...
public:
	...
	//写入积分
    virtual bool WriteUserScore(SCORE lScore, SCORE lRevenue,SCORE lUserMedal,BYTE cbScoreType, DWORD dwPlayTimeCount);

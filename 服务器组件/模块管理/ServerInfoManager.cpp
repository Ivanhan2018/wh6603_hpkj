...
bool CServerInfoManager::InsertGameServer(tagGameServerCreate * pGameServerCreate, tagGameServerInfo & GameServerResult)
{
	...
	try
	{
		...
		//EWIN网络科技 使用非官方内核需要使用下边注译语句
		//CString szlCellScore;			  
		//szlCellScore.Format(TEXT("%0.2f"),pGameServerCreate->lCellScore);
		//PlatformDBAide.AddParameter(TEXT("@lCellScore"),szlCellScore);
		...
		PlatformDBAide.AddParameter(TEXT("@strServerPasswd"),pGameServerCreate->szServerPassWork);
		...
		PlatformDBAide.AddParameter(TEXT("@wMinGameUser"),pGameServerCreate->wMinGameUser);
		PlatformDBAide.AddParameter(TEXT("@wMaxGameUser"),pGameServerCreate->wMaxGameUser);
		...
		//虚拟人数
		PlatformDBAide.AddParameter(TEXT("@wVirtualUserCount"),pGameServerCreate->wVirtualUserCount);
...
bool CServerInfoManager::ReadGameServerInfo(CDataBaseAide & PlatformDBAide, tagGameServerInfo & GameServerResult)
{
	...
	PlatformDBAide.GetValue_String(TEXT("ServerPasswd"),GameServerResult.szServerPassWork,CountArray(GameServerResult.szServerPassWork));
	
	//虚拟人数
	GameServerResult.wVirtualUserCount=PlatformDBAide.GetValue_WORD(TEXT("VirtualUserCount"));
	...
	GameServerResult.wMinGameUser=PlatformDBAide.GetValue_WORD(TEXT("MinGameUser"));
	GameServerResult.wMaxGameUser=PlatformDBAide.GetValue_WORD(TEXT("MaxGameUser"));
